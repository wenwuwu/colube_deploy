...
module.exports = ({ cache, config }) => {
  ...
  exports.update = async (req, res) => {
    ...
    if (!latest.platforms || !latest.platforms[platform]) {
        ...
        console.log(`latest.platforms ----------`, latest.platforms);
    ...
    if (compare(latest.version, version) !== 0) {
      ...
      //let url2 = shouldProxyPrivateDownload ? `${url}/download/${platformName}?update=true` : latest.platforms[platform].url;
      let url2 = latest.platforms[platform].url;
